...
def downgrade():
    # Remove indexes
    op.drop_index('idx_market_snapshots_symbol_timestamp', 
                  table_name='market_snapshots')
    op.drop_index('idx_option_chain_symbol_expiry', 
                  table_name='option_chain_snapshots')
    op.drop_index('idx_option_chain_strike_expiry', 
                  table_name='option_chain_snapshots')
    op.drop_index('idx_smart_money_symbol_timestamp', 
                  table_name='smart_money_predictions')
