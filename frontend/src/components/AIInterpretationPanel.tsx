    ...
    return (
      <div className="bg-[#111827] rounded-xl p-5 border border-[#1F2937] h-full">
        ...
        <div className="flex flex-col items-center justify-center py-10 text-gray-500">
          <div className="w-8 h-8 border-2 border-gray-700 border-t-gray-500 rounded-full animate-spin mb-2" />
          <p className="text-sm font-mono tracking-wider">Analyzing market structure...</p>
        </div>
      </div>
    );
  }
