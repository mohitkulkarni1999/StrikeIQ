...
function AuthProvider({ children }) {
    ...
    const handleAuthRequired = (authData)=>{
        // Always dispatch auth required state
        dispatch({
            type: 'AUTH_REQUIRED',
            payload: {
...
function DashboardComponent({ symbol }) {
    ...
    // Show AuthScreen if authentication required from AuthContext
...
_s(DashboardComponent, "3dVNomkaXm5xx57J/43Z3M644fo=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$AuthContext$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__["useAuth"],
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d3723b82._.js.map