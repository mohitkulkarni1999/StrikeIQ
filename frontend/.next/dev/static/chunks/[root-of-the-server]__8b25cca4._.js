...
function AuthProvider({ children }) {
    ...
    const checkAuth = async ()=>{
        ...
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$axios$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].get('/api/v1/market-data/NIFTY');
...
function useLiveMarketData(symbol, expiry) {
    _s();
    console.log("🚀 Enhanced useLiveMarketData INIT", {
        symbol,
        expiry
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8b25cca4._.js.map