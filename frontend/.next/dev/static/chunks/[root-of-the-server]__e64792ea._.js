...
function AuthPage() {
    ...
    const [checkingAuth, setCheckingAuth] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(true);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthPage.useEffect": ()=>{
            // First check if user is already authenticated
            const checkExistingAuth = {
                "AuthPage.useEffect.checkExistingAuth": async ()=>{
                    try {
                        const response = await fetch('/api/v1/market/status');
                        const data = await response.json();
                        console.log('🔍 AuthPage: Auth check response:', data);
                        ...
                        console.log('🔍 AuthPage: Authentication required, showing auth screen');
            ...
            }["AuthPage.useEffect.checkExistingAuth"];
            checkExistingAuth();
        }
    }["AuthPage.useEffect"], [
        router
...
_s(AuthPage, "uZZk8RI630OKO9em80fjhbBorGY=", false, function() {
    return [
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e64792ea._.js.map