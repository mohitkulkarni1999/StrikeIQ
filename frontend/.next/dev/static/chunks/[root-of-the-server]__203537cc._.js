...
function Dashboard({ initialSymbol = "NIFTY" }) {
    ...
    const { data, status, error, loading, mode } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useLiveMarketDataEnhanced$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["useLiveMarketData"])(symbol, selectedExpiry);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Dashboard.useEffect": ()=>{
            const fetchExpiries = {
                "Dashboard.useEffect.fetchExpiries": async ()=>{
                    try {
                        const res = await fetch(`http://localhost:8000/api/v1/options/contract/${symbol}`);
                        if (!res.ok) {
            ...
            }["Dashboard.useEffect.fetchExpiries"];
            fetchExpiries();
        }
    }["Dashboard.useEffect"], [
        symbol
...
//# sourceMappingURL=%5Broot-of-the-server%5D__203537cc._.js.map