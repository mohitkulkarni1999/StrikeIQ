module.exports = [
"[project]/src/lib/axios.ts [ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useLiveMarketData(symbol, expiry) {
    ...
    const fallbackToRest = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useCallback"])(()=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["default"].get(`/api/v1/options/chain/${symbol}?expiry_date=${expiry}`).then((response)=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__af8a514e._.js.map