...
function useLiveMarketData(symbol, expiry) {
    ...
    (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
        ...
        connectWebSocket();
        // Set a timeout to fallback to REST if WebSocket doesn't connect
        const fallbackTimeout = setTimeout(()=>{
            if (mode === 'loading') {
                console.log(`⏰ WebSocket timeout, falling back to REST for ${symbol}`);
                fallbackToRest();
            }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__166c748e._.js.map