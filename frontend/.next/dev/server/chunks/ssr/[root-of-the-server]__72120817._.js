        ...
        if (selectedExpiry) {
            const fetchOptionChain = async ()=>{
                try {
                    ...
                    // Extract spot price from the first call/put data or find ATM strike
                    let currentSpotPrice = null;
                    if (calls.length > 0) {
                        // Find the strike closest to spot (ATM) - this is usually the current spot
                        const sortedCalls = [
                            ...calls
...
//# sourceMappingURL=%5Broot-of-the-server%5D__72120817._.js.map