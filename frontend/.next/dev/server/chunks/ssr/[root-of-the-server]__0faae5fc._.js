...
"[project]/src/types/dashboard.ts [ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$dashboard$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/types/dashboard.ts [ssr] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
...
function AuthProvider({ children }) {
    ...
    const checkAuth = async ()=>{
        ...
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$axios$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["default"].get('/api/v1/market-data/NIFTY');
            const data = response.data;
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$dashboard$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["isAuthRequired"])(data)) {
                dispatch({
                    type: 'AUTH_REQUIRED',
                    payload: {
...
"[project]/src/hooks/useLiveMarketDataEnhanced.ts [ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useLiveMarketData(symbol, expiry) {
    ...
    const [marketStatus, setMarketStatus] = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useState"])(null);
    ...
    const reconnectRef = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useRef"])(0);
    const mountedRef = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useRef"])(true);
    const pollIntervalRef = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useRef"])(null);
    const marketStatusIntervalRef = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useRef"])(null);
    ...
    const fetchMarketStatus = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useCallback"])(async ()=>{
        try {
    ...
    const connectWebSocket = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useCallback"])((symbol, expiry)=>{
        if (!symbol || mode !== 'live') {
    ...
    const pollMarketData = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useCallback"])(async ()=>{
...
var __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/react/jsx-dev-runtime [external] (react/jsx-dev-runtime, cjs)");
var __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/react [external] (react, cjs)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useLiveMarketDataEnhanced$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/useLiveMarketDataEnhanced.ts [ssr] (ecmascript)");
...
function Navbar() {
    ...
    const { mode } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useLiveMarketDataEnhanced$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["useLiveMarketData"])(symbol, null);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0faae5fc._.js.map